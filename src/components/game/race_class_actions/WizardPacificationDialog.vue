    ...
    <v-container>
        ...
        <v-btn class="text-center">
            <v-dialog v-model="dialog" max-width="600">
                ...
                <v-card>
                    <v-card-title class="text-center"> Волшебник: Изгнание</v-card-title>
                    <div class="text-center subtitle">Заклинание Усмирения: Можешь
...
export default {
    ...
    methods: {
        ...
        async doWizardPacification() {
            ...
            var cardId = this.selectedCards[0] ? this.selectedCards[0].id : "null";


            // Construct the endpoint URL with the card IDs
            var endpointUrl = `wizard_pacification/${id}?cardId=${cardId}`;
